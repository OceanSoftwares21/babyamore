...
const Signinotpscreen = (props) => {
    var _id = props.route.params.id
    ...
    const verifyfunction = () => {
        // axios.post(`http://54.255.246.233:5000/UserEmployee/otpverify/Phone/${_id}`)
        //     .then(response => {
        //         console.log(response.data)
        //         if (response.data.message == "You has been successfully registered") {
